...
public class Constants {
	...
	public static final String PROJECT_FULL_PATH = PROJECT_BASE_PATH + File.separator + "SeleniumAppiumDemo" + File.separator;
	public static final String TEST_PROPERTIES_FILE_PATH = PROJECT_FULL_PATH + "config" + File.separator + "test.properties";
	public static final String REPORTS_SCREENSHOTS_PATH = Constants.PROJECT_FULL_PATH + File.separator + "reports"
